...
void getValuesFromFile(double arrays[], string file_names)
{
    ifstream inputFile;

    inputFile.open(file_names);
...
int inputValidate(int users_number, int lowest, int highest)
{
    while (!users_number || (users_number < lowest || users_number > highest))
    {
